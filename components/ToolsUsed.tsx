...
export default function ToolsUsed() {
  return (
    <section className="max-w-[1440px] w-full mx-auto relative">
      <div className="absolute w-full top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 h-full inset-0 -z-10 opacity-80 scale-180">
        <Image
          src="/particles.png"
          alt=""
          fill
      ...
      <div className="px-16 py-3 max-sm:px-8 max-sm:py-4 text-center">
        <h1 className="text-heading3 font-bold text-chart-3 mb-[10px]">
          Built for Security
        </h1>
        <p className="text-[15px] max-w-[800px] w-full mx-auto max-md:text-[12px] font-medium">
          ...
          their data being used by unauthorised personals.
        </p>
      </div>
